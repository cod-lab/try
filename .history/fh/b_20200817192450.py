...
try:
    # response = re.get('https://api.github.com/users/cod-lab/repos?sort=created, timeout=10)
    response = re.get('https://api.github.com/users/cod-lab/repos', params=payload, timeout=10)
except Timeout:
