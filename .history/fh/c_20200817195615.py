...
def get_repos_list(new_list):
    ...
    # try:
        # response = r.get('https://api.github.com/users/cod-lab/repos?sort=created, timeout=10)                    # also works
...
print('get_repos block\n')
try: get_repos_list(new_list)
except r.exceptions.ConnectTimeout: print('The server is not responding currently!!\nPlease try again later..')
print('\nget_repos block end')
