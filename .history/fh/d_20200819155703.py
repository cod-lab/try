...
# Get Current List
def read_file(file,current_list,l1):
...
def write_file(file,current_list,new_list,l1):
    with open(file,'w') as f:
        for i in range(1,len(current_list)):
            f.write(str(current_list[i][0]))
...
print('\nread_file block----------------------\n')
try: read_file(file,current_list,l1)
...
if diff>0:
print('\nwrite_file block----------------------\n')
write_file(file,current_list,new_list,l1)
