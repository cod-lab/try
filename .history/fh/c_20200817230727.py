...
except FileNotFoundError as e: s.exit(e)          # terminate prgm right away after printing msg
print('\nread_file block end------------------\n')

print('\nget_repos block----------------------\n')
try: get_repos_list(user,new_list)      # .ReadTimeout
...
# except r.exceptions.ConnectTimeout as e: s.exit(e)          # terminate prgm right away after printing msg
print('\nget_repos block end------------------\n')
